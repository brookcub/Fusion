          ...
          try {
            ...
            */
            ...
            const removal = await removeDirectoryWithRetry({
              path: canonicalPath,
              // FNXC:MergeResponsiveness 2026-09-06-05:09: Background cleanup must yield just like inline pruning so dependency-heavy stale trees cannot monopolize health and operator pause.
              rm,
