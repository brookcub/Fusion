...
export function buildMergeSystemPrompt(
  ...
  return [
    ...
    "  - The engine runs the resolved required verification commands on your",
    "    reviewed squash before landing. Do not discover or launch test, lint,",
    "    typecheck, or build commands yourself; do not duplicate those checks.",
    "  - Your job is to reconcile the branches and author the squash. Engine",
    "    verification failure prevents landing; never claim unrun checks passed.",
    "",
    "Commit message:",
